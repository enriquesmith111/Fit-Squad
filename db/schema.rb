...
ActiveRecord::Schema[7.0].define(version: 2023_09_08_173542) do
  ...
  create_table "workout_preferences", force: :cascade do |t|
    t.bigint "user_id", null: false
    ...
    t.datetime "updated_at", null: false
    t.text "workout_plan"
    t.index ["user_id"], name: "index_workout_preferences_on_user_id"
  end
  ...
  add_foreign_key "workout_preferences", "users"
end
